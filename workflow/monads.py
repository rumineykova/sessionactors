...
if __name__ == "__main__":
    ...
    def continuation_monad_example():
        ...
        @do(ContinuationMonad)
        def multiply(values, factor, orig, mult, me):
            print 'In multiply'

        @do(ContinuationMonad)
        def sum(values, factor, orig, sum, me):
            print 'In sum'

        @do(ContinuationMonad)
        def avg(values, factor, orig, avg, me):
            print 'In avg'
